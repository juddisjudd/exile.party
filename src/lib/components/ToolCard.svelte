...
<!-- Four things: icon, name, by-line, one line. The tool page carries the rest. The one exception
     is a status pill for a tool that has stopped, which a browser needs before clicking through. -->
<li
